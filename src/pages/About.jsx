    ...
    <div className="container py-5">
      ...
      <div className="text mt-4">
        <p className=" text-center pt-5">
          ...
          of turning complex problems into simple, elegant solutions. I am
          always focused on creating the best possible experience for users.
          Feel free to explore my portfolio and get in touch for collaborations
          or freelance opportunities. Feel free to get in touch with me on
        </p>

        <p className="text-center">
          <a
            href="https://www.facebook.com/profile.php?id=100045760576430"
            target="_blank"
